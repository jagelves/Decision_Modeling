...
Demand (Bottles): Modeled by a triangular distribution with a minimum of 500, most likely 1,500, and maximum of 2,500 bottles.
Production Costs: 10,000 fixed plus 15 per bottle.
Selling Price: 100 per bottle.
Salvage Value: 30 per unsold bottle (up to 1,000 bottles).
The maximum number of bottles that can be produced is also uncertain and follows a Beta distribution with parameters α = 2 and β = 5, scaled to a maximum capacity of 3,000 bottles.

The winery is considering production levels ranging from 1,000 to 3,000 bottles in increments of 500.
