...
Before we can build our simulation models, we must learn the tools to perform the analysis. In this module, we'll learn how to store data in R, generate random numbers, use loops and conditionals, and transform vectors to simulate real data.
