...
Use the NAIVE, TSLM model with a simple trends, and a TSLM model with quadratic trend, to provide a four year forecast. Which method provides the best forecast?
