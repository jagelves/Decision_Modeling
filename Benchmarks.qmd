...
<https://jagelves.github.io/Data/UNPOP.csv> to plot the fertility rate for the US from 1960-2022 and the current replacement rate. What is the two year projected fertility rate when using a simple linear trend? How does this change when using a quadratic trend?
