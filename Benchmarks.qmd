...
1. The Japanese government has hired you to forecast their total population by 2030 so that they can better allocate resources, and plan for future needs. You can find population data here: <https://jagelves.github.io/Data/UNPOP.csv>
Use the TSLM model with a simple trend and a TSLM model with quadratic trend. Which model has the better BIC? Provide a your estimate using the best model. Is the population expected to go up or down?
